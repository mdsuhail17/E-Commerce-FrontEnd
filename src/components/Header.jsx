...
export default function Header() {
 ...
 const handleClickOutside = (event) => {
  ...
  const navLinkClass =
    "text-center text-lg font-primary font-semibold text-primary py-2 dark:text-light hover:text-dark dark:hover:text-light";
    ...
    <header className="border-b border-gray-300 dark:border-gray-600 sticky top-0 z-20 bg-normalbg dark:bg-darkbg">
      ...
      <div className="flex items-center justify-between mx-auto max-w-[1152px] px-6 py-4">
        ...
        <nav className="flex items-center py-2 z-10">
          ...
          <button   className="flex items-center justify-center mx-3 w-8 h-8 rounded-full border border-primary dark:border-light transition duration-300 hover:bg-gray-300 dark:hover:bg-gray-600"
